...
{
    public partial class sitrepform : Form
    {
        string responders = "";
        public sitrepform()
        {
        ...
        {
            //if datetime now is morning show this text
        ...
        {
            //copy the text in the previewbox to clipboard
        ...
        {
            //if else statement for the reset button
